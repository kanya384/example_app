...
func TestUpdateUser(t *testing.T) {
	...
	updateFunc := func(oldUser *user.User) (*user.User, error) {
		return user.NewWithID(oldUser.ID(), oldUser.CreatedAt(), time.Now().UTC(), newUser.Name(), newUser.Surname(), newUser.Phone(), newUser.Pass(), newUser.Email(), newUser.Verified(), newUser.Role())
	}
